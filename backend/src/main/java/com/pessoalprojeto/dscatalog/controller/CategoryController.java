...
public class CategoryController {
	...
	public ResponseEntity<Page <CategoryDTO>> findAllPaged(
			/*Pageable é uma interface do Spring Framework que fornece recursos de paginação e ordenação de
			 dados em uma consulta, permitindo consultas mais eficientes e escaláveis em APIs e camadas de 
			 acesso a dados.*/
			Pageable pageable){
